        ...
        if header_values:
            ...
            for name, response_params in parsed_header_values:
                for extension_factory in available_extensions:
                    ...
                    # Break output of the loop once we have a match.
                    break
...
class Connect:
    ...
    let the exception bubble up and break output of the loop. This lets you
    ...
    * You can set ``host`` and ``port`` to connect to a different host and
    ...
    Raises:
        ...
        ~asyncio.TimeoutError: If the opening handshake times output.
