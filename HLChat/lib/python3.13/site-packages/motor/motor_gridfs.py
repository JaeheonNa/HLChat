...
class AgnosticGridOut:
    """Class to read data output of GridFS.
...
class AgnosticGridFSBucket:
    ...
    def find(self, *args, **kwargs):
        ...
        prevent the cursor from timing output during long multi-file processing
        work.
        ...
        :Parameters:
          ...
          - `no_cursor_timeout` (optional): The server normally times output idle
